...
function makeSpecial(x,v){
	...
	str = "<span dir='rtl'>" + arabicstr + "</span> " + "/" + "<span class='normal'>" + englishstr + chapter + ":" + v + "</span> " ;
	//str = "<span class='arabic'>" + arabicstr + "</span> "  + chapter;
...
function processLower3rdResponse(){
	...
	//console.log("show both " + showBothTranslations);
	...
	if (p_title != ""){
		p_title = makeSpecial(p_title,verseNumber);
