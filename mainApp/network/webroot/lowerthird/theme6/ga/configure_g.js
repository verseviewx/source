...
var isArabic = true;		// Set to true if the language reads right to left

var showBothTranslations = false;	//Change to true to show both translations 
var spaceBetweenTranslations = 30;
var showVerseSideBySide = false;		//If true, then the dual verses will shows left and right
...
var backgroundFilenameFullBox = './img/g11.png';
var backgroundFilenameVerseBox = './img/g12.png';
...
var text1_style = {
	...
	"font-weight" : "normal",		//Options are bold, normal
	"font-style" : "normal",		//Options are italics, normal
	"text-align" : "right",		//Options are left, center , right
	"text-decoration": "none",
	"direction": "rtl",
	"letter-spacing": "",	//Example: "5px"
	"line-height": "",		//Example: "1.5"
